...
const AdminAppointmentPage = () => {
  ...
  useEffect(() => {
    fetch('https://api.devcapsule.com/appointments')
      .then(res => res.json())
      .then(data => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      const res = await fetch(`https://api.devcapsule.com/appointments/${itemToDelete._id}`, {
        method: 'DELETE',
      });
  ...
  const confirmStatusChange = async () => {
    ...
    try {
      const res = await fetch(`https://api.devcapsule.com/appointments/${itemToUpdate._id}`, {
        method: 'PATCH',
        headers: {
